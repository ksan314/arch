...
sleep 2
pacman -S --needed arch-wiki-docs arch-wiki-lite base base-devel bash bash-completion btrfs-progs coreutils exfat-utils grub ifuse libimobiledevice man-db man-pages mlocate networkmanager npm ntfs-3g pinfo python-pip reflector rsync tldr trash-cli unzip zip
